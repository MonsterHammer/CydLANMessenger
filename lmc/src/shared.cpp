...
#if defined Q_OS_WIN
	osName = QString("Windows %1").arg(QSysInfo::productVersion());
#elif defined Q_OS_MAC
	osName = QString("macOS %1").arg(QSysInfo::productVersion());
#elif defined Q_OS_LINUX
	osName = QString("Linux %1").arg(QSysInfo::kernelVersion());
#endif
